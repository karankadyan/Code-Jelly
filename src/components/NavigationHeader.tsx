...
import {BugPlay, Code2, Sparkles} from "lucide-react";
...
function NavigationHeader() {
    return (
        <div
            className="sticky top-0 z-50 w-full bg-gray-950 backdrop-blur-xl backdrop-saturate-150">
            {/*<div className="absolute inset-0 bg-gradient-to-r from-blue-500/5 to-purple-500/5"/>*/}
            <div className="absolute inset-0 bg-gray-950"/>
            <div className="max-w-7xl mx-auto px-4">
                <div className="relative mt-4 p-2 mb-4 flex items-center justify-between">
